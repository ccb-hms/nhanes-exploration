...
such as the variable type and number of non-missing observations. More
details are given in [cite
<https://ccb-hms.github.io/phonto/vignettes/search-tables.html>],
which also provides links to publicly accessible online search
interfaces.
