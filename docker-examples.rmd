...
be interesting. Somewhat more surprisingly, several variables appear
...
but some hints are provided by the data counts included in the
codebook. For example, for the 2005--2006 cycle, we have
...
This may not be true for all variables. [Find Example]
