...
function), including a usually shorter description of each variable
referred to as the "SAS Label", along with information about possible
response values and their counts, including the number of missing
values. 
